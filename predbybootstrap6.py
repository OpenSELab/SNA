...
if __name__ == '__main__':
    # N = mp.cpu_count()
    g = os.walk(r"/home/local/SAIL/linagong/mygrap/data2/aa/")
    path3="/home/local/SAIL/linagong/mygrap/new/VIF/"
    ...
    for path, dir_list, file_list in g:
        for file_name in file_list:
            ...
            s1 =os.path.join(path3, file_name)
            df = pd.read_csv(s)
            ...
            # lrModel1 = RandomForestRegressor(n_estimators=500, criterion='mse',n_jobs=35)
            #
            # lrModel2 = RandomForestClassifier(n_estimators=500, n_jobs=35)
            n_repeats = 100
            # 预测缺陷数指标
            ...
            for i in range(0, n_repeats):
               ...
               # x_SNA_test2 = pca_SNA.transform(x_SNA_test)
                ...
                n = x_test.shape[0]
                print(x_SNA_train2.shape, x_ENs_train2.shape,x_GNs_train2.shape,x_MET_train2.shape, x_SM_train2.shape)
                ...
                print(adj_MET[i], adj_SNA[i], adj_GNs[i], adj_ENs[i], adj_SM[i], adj_COM[i])
                ...
                # prob.to_csv('E:\\mygrap\\new\\cross-project\\Hive\\Lucene\\proness\\' + s + '_' + str(i) + '.csv', index=False)
                #
                ...
                # number.to_csv('E:\\mygrap\\new\\cross-project\\Hive\\Lucene\\number\\' + s + '_' + str(i) + '.csv', index=False)
            ...
            s_Adj = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/Adj/' + file_name + '_Adj.csv'
            print(s_Adj)
            result2.to_csv(s_Adj, index=False)
            ...
            s_MAE = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/MAE/' + file_name + '_MAE.csv'
            result3.to_csv(s_MAE, index=False)
            ...
            s_Spearman = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/Spearman/' + file_name + '_Spearman.csv'
            result4.to_csv(s_Spearman, index=False)
            #
            ...
            s_RMSE = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/RMSE/' + file_name + '_RMSE.csv'
            result5.to_csv(s_RMSE, index=False)

            frames6 = [data_Recall_MET, data_Recall_SNA, data_Recall_SM, data_Recall_ENs, data_Recall_GNs,
                       data_Recall_COM]
            result6 = pd.concat(frames6)
            result6.columns = ['values', 'metrics', 'measure']
            s_Recall = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/Recall/' + file_name + '_Recall.csv'
            result6.to_csv(s_Recall, index=False)
            ...
            s_AUC = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/AUC/' + file_name + '_AUC.csv'
            result7.to_csv(s_AUC, index=False)
            ...
            s_MCC = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/MCC/' + file_name + '_MCC.csv'
            result8.to_csv(s_MCC, index=False)
            ...
            s_Bri = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/Bri/' + file_name + '_Bri.csv'
            result9.to_csv(s_Bri, index=False)
            ...
            s_CE = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/CE/' + file_name + '_CE.csv'
            result10.to_csv(s_CE, index=False)
            ...
            s_ER = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/ER/' + file_name + '_ER.csv'
            result11.to_csv(s_ER, index=False)

            frames12 = [data_Precision_MET, data_Precision_SNA, data_Precision_SM, data_Precision_ENs,
                        data_Precision_GNs, data_Precision_COM]
            result12 = pd.concat(frames12)
            result12.columns = ['values', 'metrics', 'measure']
            s_Precision = '/home/local/SAIL/linagong/mygrap/new/new/within/normalization/original/Precision/' + file_name + '_Precision.csv'
            result12.to_csv(s_Precision, index=False)
